...
class RecipeCorpus {
    ...
    constructor(fileName) {
        ...
        if (RecipeCorpus.instance instanceof RecipeCorpus) {
            // Will always return a prebuilt corpus
            return RecipeCorpus.instance;
        }
        RecipeCorpus.instance = this;
        ...
        try {
            ...
            console.log("Recipe RecipeCorpus Exists");
            //Parse JSON
            ...
            for (let i = 0; i < this.recipesCount; i += 1) {
                ...
                this.keywordList=tempKeywords.filter(function (item)
                {
                    ...
                    const stopWords = ['the', 'of', 'and', 'is','to','in','a','from','by','that',   'as', 'an', 'are','its', 'at', 'for'];
            ...
            console.log("Error: RecipeCorpus Does Not Exists");
    ...
    getIntentFromText(rawText){
        ...
        {
            // List of stop words to be filtered out from the list
            const stopWords = ['the', 'of', 'and', 'is','to','in','a','from','by','that',  'this', 'as', 'an', 'are','its', 'at', 'for'];
    ...
    parseIngredients(ingredientArray) {
        let text ="";
